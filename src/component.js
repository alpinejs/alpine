            ...
            getXAttrs(el).forEach(({
                ...
                switch (type) {
                    ...
                    case 'model':
                        ...
                        var event = (el.tagName.toLowerCase() === 'select') || ['checkbox', 'radio'].includes(el.type) ||
                        ...
                        var {
                            output
                        } = this.evaluateReturnExpression(expression)
            ...
            getXAttrs(el).forEach(({
                ...
                switch (type) {
                    case 'bind':
                        ...
                        var {
                            output, deps
                        } = self.evaluateReturnExpression(expression)
