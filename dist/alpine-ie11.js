...
=======
  ...
  _export({ target: 'Object', stat: true }, {
    values: function values(O) {
      return $values(O);
>>>>>>> 85bb4a267e0eb3e2dcd18ad62308e426fb889a16
    }
  });
  ...
  function saferEval(expression, dataContext) {
    ...
    return new Function(['$data', '$extraVars'], "var result; with($extraVars) { with($data) { result = ".concat(expression, " } }; return result"))(dataContext, additionalHelperVariables);
  }
  function saferEvalNoReturn(expression, dataContext) {
    ...
    if (Object.keys(dataContext).includes(expression)) {
      var methodReference = new Function(['dataContext', '$extraVars'], "with($extraVars) { with(dataContext) { return ".concat(expression, " } }"))(dataContext, additionalHelperVariables);
    ...
    return new Function(['dataContext', '$extraVars'], "with($extraVars) { with(dataContext) { ".concat(expression, " } }"))(dataContext, additionalHelperVariables);
  }
  ...
  function handleForDirective(component, el, expression, initialUpdate, extraVars) {
    ...
    items.forEach(function (i, index, group) {
      ...
      if (currentEl && currentEl.__x_for_key !== undefined) {
        ...
        Object.defineProperty(_xForVars, single, {
          get: function get() {
            return i;
          },
          set: function set(newValue) {
